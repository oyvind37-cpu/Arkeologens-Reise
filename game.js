...
const prologueImage=$("prologueImage");
...
const prologueScenes=[
  ...
  },
  {
    ...
    image:"prologue_05_scan.jpg",
    text:"Aurora reiser til Kairo. Teamet bruker avansert røntgenskanning, virtuell utrulling og mønstergjenkjenning med kunstig intelligens for å forsøke å lese teksten uten å bryte seglene. Etter flere dager dukker noe uventet opp: koordinater."
  },
  {
    kicker:"UT I ØRKENEN",
    title:"Et punkt ingen har undersøkt",
    image:"prologue_06_desert.jpg",
    text:"Etter tre–fire dager i Kairo bestemmer Aurora seg for å følge koordinatene. Museet skaffer en erfaren kamelfører de stoler på. Sammen forlater de byen og setter kurs mot et ukjent punkt i ørkenen."
  }
];
let prologueIndex=0;
...
function renderPrologue(){
  ...
  prologueImage.style.backgroundImage=`url("${scene.image}")`;
